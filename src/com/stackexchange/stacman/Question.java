...
public final class Question {
    ...
    public Date getBountyClosesDate() { return bounty_closes_date != null ? new Date(bounty_closes_date) : null;}

    private Long closed_date;
    public Date getClosedDate() { return closed_date != null ? new Date(closed_date) : null; }
    ...
    public Date getCommunityOwnerDate() { return community_owned_date != null ? new Date(community_owned_date) : null; }
    ...
    public Date getProtectedDate() { return protected_date != null ? new Date(protected_date) : null; }
